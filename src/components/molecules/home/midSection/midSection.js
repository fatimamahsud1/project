      ...
      <div className="grid grid-cols-12 gap-5 items-center justify-center text-center">
        ...
        <div className="flex flex-col items-center justify-center col-span-12 xl:col-span-8 mt-[-10px]">
          <Typography tag="p" className="body description">
            Ahmad Online Cadet Academy offers top-tier online preparation for
            Cadet Colleges, Military, PAF, Army, and Navy Schools, all from the
            comfort of home. With live Zoom classes 5 days a week, expert
            subject specialists, weekly & monthly tests, and complete
            preparation for written exams, intelligence tests, and interviews,
            we ensure your child is fully ready to achieve their dream.
            Affordable fees, quality teaching, and a proven system, start your
            child’s journey to success today!
          </Typography>
